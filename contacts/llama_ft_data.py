...
# def convert_data_jsonl_format(questions, contexts, answers, output_file):
...
dataset_generator = RagDatasetGenerator.from_documents(
    documents,
    question_gen_query=get_prompt('fine_tune_generator'),
    llm=llm,
...
# convert_data_jsonl_format(questions, contexts, answers, "./data/training.json")
